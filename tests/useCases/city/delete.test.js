...
beforeEach(() => {
    ...
    sut = new city_2.DeleteCityUseCase(citiesRepository);
});
test('Delete city should be successful', () => __awaiter(void 0, void 0, void 0, function* () {
    // Arrange
...
test('Delete city should return not found', () => __awaiter(void 0, void 0, void 0, function* () {
    // Arrange
